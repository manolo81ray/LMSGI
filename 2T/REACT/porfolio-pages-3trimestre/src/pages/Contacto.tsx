...
export const Contacto = () => {
    return(
        <section id="contacto" className=" relative overflow-hidden pt-20 py-10">
            <div
                aria-hidden="true"
            ...
            <div className="isolate px-6 py-8 sm:py-10 lg:px-8">
                ...
                <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-8">
                    ...
                    <div className="flex gap-x-4 sm:col-span-2">
                        ...
                        <div className="group relative inline-flex w-8 shrink-0 rounded-full bg-white/5 p-px inset-ring inset-ring-white/10 outline-offset-2 outline-indigo-500 transition-colors duration-200 ease-in-out has-checked:bg-indigo-500 has-focus-visible:outline-2">
                            ...
                            className="absolute inset-0 size-full appearance-none focus:outline-hidden pointer-events-none"
                            />
                        </div>
                        </div>
