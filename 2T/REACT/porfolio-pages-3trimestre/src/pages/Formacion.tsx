...
// arrai de objetos JS
//EXISTEN DOS TIPOS DE ARRAI: JS(sin comillas) Y JSON(entre comillas)
const formacion = [
    {
        id: 1,
        ...
        // fecha cuando se finalizo
        date: '01/06/2020',
        datetime: '2020-03-16',
        category: { title: 'Informatica', href: '#' },
        author: {
        name: 'Michael Foster',
        role: 'Co-Founder / CTO',
        href: '#',
    ...
    {
        id: 2,
        title: 'Ciclo de Grado Superior de ASIR',
        href: '#',
    ...
    {
        id: 3,
        title: 'Curso de especializacion en Ciberseguridad',
        href: '#',
        description:
    ...
    {
        id: 4,
        title: 'Curso de especializacion en Bid Data y data Analytics',
        href: '#',
        description:
        'Cupiditate maiores ullam eveniet adipisci in doloribus nulla minus. Voluptas iusto libero adipisci rem et corporis. Nostrud sint anim sunt aliqua. Nulla eu labore irure incididunt velit cillum quis magna dolore.',
        date: '01/11/2020',
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        ...
                        {formacion.map((titulo) => (
                            ...
                            <div className="flex items-center gap-x-4 text-xs">
                                ...
                                className="relative z-10 rounded-full bg-yellow-800/30 px-3 py-1.5 font-medium
