...
export const CursosCard = ({ cursos }: Props) => {
    ...
    return (
        <section className="bg-[#0b1326] py-16 px-6 lg:px-24 min-h-screen">
            <div className="max-w-screen-xl mx-auto">
                ...
                <header className="mb-16 md:mb-16 text-center flex flex-col items-center">
                    <span className="block font-sans text-[#e9c349] text-[10px] md:text-xs font-bold tracking-[0.25em] uppercase mb-4">
                        02 / Technical Mastery
                    </span>
                    
                    <h1 className="font-serif text-5xl md:text-6xl text-[#e4e7f0] leading-none tracking-tighter italic font-light">
