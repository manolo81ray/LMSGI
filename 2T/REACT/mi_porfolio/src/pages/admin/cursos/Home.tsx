...
import { getCursos, deleteCurso, updateCursoVisible } from "@/model/api/backend/cursos/apiCursos"
...
export const CursosHome = () => {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            >
                <CursosTable cursos={paginated} loading={loading} onEdit={handleEditar} onDelete={setToDelete} onHide={handleHide} onShow={handleShow} />
            </AdminTableShell>
