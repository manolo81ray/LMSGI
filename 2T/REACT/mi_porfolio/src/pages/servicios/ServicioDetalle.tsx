    ...
    if (error || !servicio) {
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center text-center px-6">
                <h1 className="font-serif text-5xl text-foreground mb-6">Service <span className="italic text-primary">Not Found</span></h1>
                <Link to="/servicios" className="text-primary font-sans text-sm font-bold tracking-[0.2em] uppercase border-b border-primary/30 pb-1 hover:border-primary transition-colors">
                    ← Back to Ecosystem
                </Link>
            </div>
        );
            ...
            <section className="pt-8 md:pt-12 pb-24 px-6 lg:px-24 max-w-screen-2xl mx-auto">
                ...
                <Breadcrumb className="mb-10">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>{servicio.nombre}</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="flex flex-col">
                        <span className="font-sans text-primary text-[10px] font-bold tracking-[0.25em] uppercase mb-6">
                            {servicio.tipo}
                        </span>
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
                            <span className="font-serif text-primary text-4xl tracking-tight">
                                {servicio.precio} €
                            </span>
                            <Link
                                to="/contacto"
